Component({
  data: {
    ...
    list: [
      ...
      { pagePath: '/pages/fund-list/fund-list', text: '我的', icon: '/images/tab-fund.svg', iconActive: '/images/tab-fund-active.svg', iconActiveRed: '/images/tab-fund-active-red.svg' }
    ]
  },
  methods: {
    switchTab(e) {
